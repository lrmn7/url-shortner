...
const htmlend = `
<footer><hr>
<subtitle style="font-size:0.8rem;color:white">Similar Services <a href="${DEFAULT_BASE}">codez.ml</a> | <a href="https://LRMN.CARRD.CO">dcbot.ml</a> | <a href="https://github.com/LRMN">getcodes.ml</a>
<br>
</subtitle>
<subtitle style="font-size:0.8rem;color:white">L RMN <a href="${DEFAULT_BASE}">Home</a> | <a href="https://LRMN.CARRD.CO">LRMN</a> | <a href="https://github.com/LRMN">Github</a>
</subtitle></footer>
</div>
...
app.get("/db/clear", async (req, res) => {
  ...
  if (!(username === process.env.username || "lrmn " && password === process.env.password || "spicydevs.me")) {
